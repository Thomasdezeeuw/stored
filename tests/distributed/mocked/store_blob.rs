...
fn fail_2pc_phase_two_vote_fail() {
    ...
    peer_stream.expect_commit_blob_request(&key, consensus_id_failed, ConsensusVote::Fail);
...
fn fail_2pc_phase_two_vote_abort() {
    ...
    let consensus_id_failed =
        peer_stream.expect_add_blob_request(&key, ConsensusVote::Commit(SystemTime::now()));
    // Vote to fail the 2PC query.
    peer_stream.expect_commit_blob_request(&key, consensus_id_failed, ConsensusVote::Abort);
...
fn fail_2pc_completely_phase_two_vote_fail() {
    ...
    let consensus_id1 =
        peer_stream.expect_add_blob_request(&key, ConsensusVote::Commit(SystemTime::now()));
    // Vote to fail the 2PC query.
    peer_stream.expect_commit_blob_request(&key, consensus_id1, ConsensusVote::Fail);
    ...
    peer_stream.expect_commit_blob_request(&key, consensus_id2, ConsensusVote::Fail);
    ...
    peer_stream.expect_commit_blob_request(&key, consensus_id3, ConsensusVote::Fail);
    peer_stream.expect_abort_store_blob_request(
        &key,
        consensus_id3,
        ConsensusVote::Commit(SystemTime::now()),
...
fn fail_2pc_completely_phase_two_vote_abort() {
    ...
    let consensus_id1 =
        peer_stream.expect_add_blob_request(&key, ConsensusVote::Commit(SystemTime::now()));
    // Vote to fail the 2PC query.
    peer_stream.expect_commit_blob_request(&key, consensus_id1, ConsensusVote::Abort);
    ...
    peer_stream.expect_commit_blob_request(&key, consensus_id2, ConsensusVote::Abort);
    ...
    peer_stream.expect_commit_blob_request(&key, consensus_id3, ConsensusVote::Abort);
    peer_stream.expect_abort_store_blob_request(
        &key,
        consensus_id3,
        ConsensusVote::Commit(SystemTime::now()),
